...
const Cards: React.FC<CardsProps> = ({ title }) => {
  return (
    <>
      <div>
        <h2 className="text-3xl font-semibold text-primary-white text-center my-6 px-2 sm:text-4xl">
          Quiero contarte un poco de mi experiencia en estas implementaciones
        </h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 m-2 md:m-0">
        <article className="relative overflow-hidden rounded-lg shadow-sm grayscale hover:grayscale-0 transition-all duration-300">
          <img
            ...
            src="src/assets/Cards/sie7e_ecuador.jpg"
        ...
        <article className="relative overflow-hidden rounded-lg shadow-sm grayscale hover:grayscale-0 transition-all duration-300">
          <img
            alt=""
            src="src/assets/Cards/wiseman_colombia.jpg"
            className="absolute inset-0 h-full w-full object-cover"
          />
          <div className="relative bg-gradient-to-t from-gray-900/50 to-gray-900/25 pt-30 sm:pt-48 lg:pt-64">
            <div className="p-4 pt-30 sm:p-6">
                <h3 className="mt-0.5 text-lg text-secondary font-bold text-right md:text-left">
                  Wiseman Colombia
                </h3>
        ...
        <article className="relative overflow-hidden rounded-lg shadow-sm grayscale hover:grayscale-0 transition-all duration-300">
          <img
            alt=""
            src="src/assets/Cards/tigo_colombia.jpg"
            className="absolute inset-0 h-full w-full object-cover"

          />
          <div className="relative bg-gradient-to-t from-gray-900/50 to-gray-900/25 pt-30 sm:pt-48 lg:pt-64">
            <div className="p-4 pt-30 sm:p-6">
                <h3 className="mt-0.5 text-lg text-secondary font-bold ">
                  TIGO Colombia
                </h3>
              <p className="line-clamp-5 text-sm/relaxed text-white/95">
